...
setup(
  ...
  packages = ['invoice2pdf'],   #* Name the package again
  ...
  description = 'This package can be used to convert Excel sheets invoices to PDF invoices.',    # Short description of your library
  author = 'SampRession',                   # Your name
  ...
  install_requires=['fpdf2', 'openpyxl', 'pandas'],                 # Other 3rd-party libs that pip needs to install
  classifiers=[
